...
from app.views import UserRegistrationView, UserLoginView, user_logout, ThreadListView, ThreadDetailView,ThreadCreateView, ThreadUpdateView, ThreadDeleteView, PostListView, post_detail, PostCreateView, PostUpdateView, PostDeleteView, my_profile, edit_profile
